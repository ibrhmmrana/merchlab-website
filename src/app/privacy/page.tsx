          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div className="border-l-4 border-red-500 pl-4">
                  ...
                  <p className="text-gray-700">
                    Data necessary to process payments, such as your payment instrument number and security code. All payment data is stored by AddPay, and you can find their privacy policy here:{" "}
                    <a 
                      href="https://southafrica.payu.com/" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                      https://southafrica.payu.com/
                    </a>
                  </p>
                </div>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li>To send you administrative information about our services and policies.</li>
                ...
                <li>To deliver services to you and respond to your inquiries.</li>
                <li>For other business purposes such as data analysis, identifying usage trends, and improving our services.</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 mb-4">
                <li><strong>Consent:</strong> Where you have given us specific consent.</li>
                <li><strong>Legitimate Interests:</strong> Where it is reasonably necessary for our legitimate business interests.</li>
                <li><strong>Performance of a Contract:</strong> Where we have a contract with you.</li>
                <li><strong>Legal Obligations:</strong> Where we are legally required to comply with applicable law.</li>
                <li><strong>Vital Interests:</strong> Where we believe it is necessary to protect the safety of any person or prevent illegal activities.</li>
              </ul>
              <p className="text-gray-700 leading-relaxed mb-4">
                More specifically, we may share your data in the following situations:
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                <li>With vendors, consultants, and other third-party service providers.</li>
                <li>In connection with a business transfer (merger, sale of assets, financing, etc.).</li>
                <li>With third-party advertising companies (subject to your consent where required).</li>
                <li>When legally required to comply with applicable law or legal process.</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li>Complain to your local data protection supervisory authority (if you are in the European Economic Area).</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                at the numbers/addresses listed on our website.
              </p>
            </section>
